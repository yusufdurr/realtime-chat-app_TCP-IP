...
public class TCPServer extends javax.swing.JFrame {
    ...
    public DefaultListModel lst_rooms_model;

    public TCPServer() throws IOException, InterruptedException {
        initComponents();
        setLocationRelativeTo(null);
        lst_clients_model = new DefaultListModel();
        lst_rooms_model = new DefaultListModel();
        this.lst_clients.setModel(lst_clients_model);
        this.lst_rooms.setModel(lst_rooms_model);
    ...
    private void initComponents() {
        ...
        jScrollPane2.setViewportView(lst_rooms);
